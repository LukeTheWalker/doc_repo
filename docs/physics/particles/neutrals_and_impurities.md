...
For a tutorial on how to run with kinetic neutrals and impurities please refer to: [[ncs_ics_tutorial | run with kinetic neutrals and impurities]].
...
For more details please refer to *S. Q. Korving et al. PoP 2023* and *PoP 2024*, take a look at kinetic_main.f90 and mod_particle_evolution.f90,  or contact [[mate.szuecs@ipp.mpg.de|Máté]] or [[D.Maris@differ.nl|Daniel]].
