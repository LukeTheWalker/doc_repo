...
Andres working on this one now. 
...
z &= Z
\end{align*}
where $(x,y,z)$ denotes Cartesian coordinates. Thus, $\phi$ goes **clockwise** if looked at from above!
...
\begin{align*}
\mathbf{a}_1 &= \begin{pmatrix} \mathrm{cos}\phi \\ -\mathrm{sin}\phi \\ 0\end{pmatrix} \\
\mathbf{a}_2 &= \begin{pmatrix} 0 \\ 0 \\ 1\end{pmatrix} \\
...
\begin{align*}
\begin{split}
\mathbf{a}^1 &= \nabla R  \qquad \mathbf{a}_1 &= J \nabla Z \times \nabla \phi \\
\mathbf{a}^2 &= \nabla Z  \qquad \mathbf{a}_2 &= J \nabla \phi \times \nabla R \\
\mathbf{a}^3 &= \nabla \phi \qquad \mathbf{a}_3 &= J \nabla R \times \nabla Z \\
\end{split}
\end{align*}
...
For details about tho COCOS convention please see
[[https://www.sciencedirect.com/science/article/pii/S0010465512002962 | Sauter, O., Medvedev, S.Yu, Computer Physics Communications 184 (2), 293-302 (2013)]].
