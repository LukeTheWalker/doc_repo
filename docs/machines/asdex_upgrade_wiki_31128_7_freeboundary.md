...
- Starting point -- ELM stable case with fixed boundary equilibrium: [31128-7-freebound-starting-point.tar.gz](assets/asdex_upgrade/31128-7-freebound-starting-point.tar.gz)
  ...
  - [R_bound,Z_bound,Psi_bound](asdex_upgrade_wiki_31128_7_psibound) different from what we used for the fixed boundary (to avoid coils inside the JOREK domain); see ~mhoelzl/liste2jorek/micdu-eqb-31128-ed7-2.4s/
